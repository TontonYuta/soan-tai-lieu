...
const InputForm: React.FC<InputFormProps> = ({ onSubmit, status }) => {
  ...
  const inputClass = "w-full pl-9 pr-3 py-2.5 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 focus:bg-white transition-all text-sm font-medium shadow-sm hover:border-indigo-300";
            ...
            <div className="grid grid-cols-2 gap-4">
                <div className="bg-slate-50 p-3 rounded-xl border border-slate-100">
                    ...
                    <input
                        type="number"
                        min="0"
                        className="w-full bg-white border-slate-200 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 font-semibold text-slate-700"
                 ...
                 {[
                     ...
                     <div key={item.k} className={`p-3 rounded-xl border ${item.c} hover:shadow-sm transition-shadow`}>
                        ...
                        <input 
                            type="number" 
                            min="0"
                            className="w-full bg-white/80 border-transparent rounded-lg px-2 py-1.5 text-sm text-center focus:ring-2 font-bold shadow-sm"
