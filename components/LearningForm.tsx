...
const LearningForm: React.FC<LearningFormProps> = ({ onSubmit, status }) => {
  ...
  const inputClass = "w-full pl-10 pr-4 py-2.5 bg-[#FEF9C3] border border-slate-200 rounded-xl focus:ring-2 focus:ring-teal-500/20 focus:border-teal-500 transition-all text-sm font-semibold text-slate-700 placeholder:text-slate-400 shadow-sm group-hover:border-teal-300";
  ...
  const selectClass = "w-full pl-10 pr-8 py-2.5 bg-[#FEF9C3] border border-slate-200 rounded-xl focus:ring-2 focus:ring-teal-500/20 focus:border-teal-500 transition-all text-sm font-semibold text-slate-700 shadow-sm appearance-none group-hover:border-teal-300 cursor-pointer";

  return (
    <div className="bg-[#FEF9C3]/80 backdrop-blur-xl rounded-[2rem] shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-white/60 p-6 lg:p-8 h-fit sticky top-28 overflow-y-auto max-h-[calc(100vh-9rem)] scrollbar-hide">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="p-5 rounded-2xl bg-slate-50/80 border border-slate-100 space-y-4 hover:border-teal-100 transition-colors duration-300">
             <div className="flex items-center gap-2 mb-2 pb-3 border-b border-slate-200/60">
                <div className="w-6 h-6 rounded-lg bg-[#FEF9C3] shadow-sm flex items-center justify-center text-teal-600">
