...
const newContent = `export const LATEX_TECHNICAL_RULES = \`
...
fs.writeFileSync("services/prompts/latex-rules.ts", newContent, "utf-8");
console.log("✓ Successfully upgraded services/prompts/latex-rules.ts with multi-subject support & Unicode map!");
